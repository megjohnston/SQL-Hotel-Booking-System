...
--
-- Host: localhost
-- Generation Time: Nov 21, 2019 at 02:36 AM
...
CREATE TABLE `Availability` (
  ...
  `MaintenanceDateFrom` date NOT NULL,
  `MaintenanceDateTo` date NOT NULL,
...
INSERT INTO `Property` (`PropertyID`, `AddressID`, `StarRatingID`, `PropertyName`) VALUES
(1, 3, 2, 'Side of the Motorway Motel'),
(2, 1, 3, 'Sunny Shores'),
(3, 2, 1, 'Luxury Suites'),
(4, 5, 4, 'Luftballon Lofts'),
(5, 4, 5, 'Marvin Gardens'),
(6, 7, 6, 'Just Like Home'),
(7, 6, 7, 'Kindling Inn'),
(8, 9, 8, 'Central Zone'),
(9, 8, 9, 'Baltic Avenue West'),
(10, 11, 12, 'Atlantic Suites'),
(11, 10, 13, 'Bates Estates'),
(12, 13, 14, 'St. Charles Place'),
(13, 12, 15, 'Park Place'),
(14, 15, 11, 'Better Than Nothing'),
(15, 14, 10, 'The Big Fish');
...
CREATE TABLE `PropertyType` (
  ...
  `TypeOfProperty` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
ALTER TABLE `PropertyType`
  MODIFY `PropertyTypeID` int(11) NOT NULL AUTO_INCREMENT;
